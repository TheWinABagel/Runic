...
public class SpellModifierAttachment {
    public static final Codec<SpellModifierAttachment> CODEC = RecordCodecBuilder.create(inst -> inst.group(
                    ...
                    RunicCodecs.SPELL_MODIFIER_CODEC.fieldOf("modifier").forGetter(a -> a.modifier),
    ...
    public SpellModifierAttachment(Spell spell, SpellModifier modifier, int maxLevel, List<ResourceLocation> requirements, int requiredLevels) {
        this.spell = spell;
