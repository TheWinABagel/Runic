...
public class SetSpellCommand {
    ...
    public static void register(LiteralArgumentBuilder<CommandSourceStack> builder) {
        builder.then(Commands.literal("spells").requires(c -> c.hasPermission(2)).then(Commands.argument("spell", ResourceLocationArgument.id()).suggests(SUGGEST_SPELL).executes(ctx -> {
